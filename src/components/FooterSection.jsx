...
function FooterSection() {
    return (
        <div className="flex lg:flex-row md:flex-col items-center lg:justify-between md:justify-around lg:gap-5 md:gap-2 lg:px-5 md:px-20 max-md:flex-wrap max-md:justify-center lg:h-fit md:h-[40vh] bg-white py-10">
            <div className="lg:self-center md:self-start flex justify-between lg:gap-6 md:gap-0 lg:my-auto md:my-2">
                <a href="#">
                    <img
                        loading="lazy"
