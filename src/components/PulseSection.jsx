...
function PulseSection() {
    ...
    return (
        <motion.div ref={ref} className='w-screen h-screen relative'>
            ...
            <motion.div style={{ scale: scaler }} className='w-full lg:h-3/4 md:h-full flex justify-center items-center absolute top-0'>
                <div className='flex lg:w-1/2 md:w-full md:h-1/2 lg:gap-2 md:gap-10 flex-col items-center'>
                    ...
                    <div className='uppercase text-white text-center lg:text-[18px] md:text-[40px] lg:font-normal md:font-semibold lg:w-[325px] lg:h-[40px] md:w-3/4 md:h-[80px] flex-shrink-0 pt-2 rounded-full bg-[#E96A54]'>secure your pass today</div>
