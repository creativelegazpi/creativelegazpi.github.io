            ...
            <section ref={ref} className="flex lg:flex-row md:flex-col h-screen max-md:gap-0">
                <div className=" lg:w-[39%] md:w-full lg:h-screen md:h-1/2 max-md:ml-0">
                    <motion.div
                        ...
                        transition={{ duration: 2, type: "spring" }} className="bg-orange-500 lg:h-screen h-full  flex flex-col w-full mx-auto px-20 py-12 max-md:max-w-full max-md:px-5">
                        <img
                            loading="lazy"
                        ...
                        <a
                            href="#"
                            className="text-white text-center lg:text-lg md:text-3xl font-bold leading-6 whitespace-nowrap bg-black lg:h-14 md:h-24  lg:w-[199px] md:w-full max-w-full items-center mt-14 mb-48 px-5 lg:py-3.5 sm:py-6 rounded-[50px] self-end max-md:my-10"
                        >
                            Coming Soon
                        </a>
                    </motion.div>
                ...
                <div className="flex flex-col items-stretch lg:w-[61%] h-full md:w-full max-md:ml-0">
                    <div className="flex h-full flex-col max-md:max-w-full">
                        <motion.div initial={{ x: 1000 }}
                            animate={{ x: isInView ? 0 : 1000 }}
                            transition={{ duration: 2, type: "spring", delay: 0.5 }} className="bg-cyan-400 h-[90vh] md:h-full flex items-center justify-between gap-5 pl-12 pr-20 py-12 max-md:max-w-full max-md:flex-wrap max-md:px-5">
