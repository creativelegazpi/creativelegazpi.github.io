                                ...
                                <div className="optionalParent">
                                    <div className="flex justify-center">
                                        <input
                                            ...
                                            className="text-white text-center lg:text-lg md:text-3xl leading-6 whitespace-nowrap bg-orange-500 self-center w-[248px] md:w-3/4 max-w-full items-center mt-8 px-5 lg:py-3.5 md:py-8 rounded-[50px]"
                                        />
